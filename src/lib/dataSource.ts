...
function demoData(): Record<DatasetKey, Row[]> {
  if (!demoTables) {
    ...
    demoTables = {
      ...
      subcategory: generated.subcategory as unknown as Row[],
      specialFeatures: generated.specialFeatures as unknown as Row[],
      trackSets: generated.trackSets as unknown as Row[],
      odometerExplanations: generated.odometerExplanations as unknown as Row[],
